...
export async function daoRoutes(fastify: FastifyInstance) {
  fastify.get('/api/dao/active', { preHandler: [requireAuth] }, async () => {
  ...
  fastify.get('/api/dao/proposals', { preHandler: [requireAuth] }, async (request) => {
  ...
  fastify.get('/api/dao/proposals/:id', { preHandler: [requireAuth] }, async (request, reply) => {
  ...
  fastify.post('/api/dao/proposals', { preHandler: [requireAuth] }, async (request, reply) => {
  ...
  fastify.post('/api/dao/proposals/:id/vote', { preHandler: [requireAuth] }, async (request, reply) => {
    const userId = (request as any).userId;
    const { id } = request.params as { id: string };
