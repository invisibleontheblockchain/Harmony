...
export async function subscriptionRoutes(fastify: FastifyInstance) {
  fastify.post('/api/subscriptions/checkout', { preHandler: [requireAuth] }, async (request, reply) => {
  ...
  fastify.get('/api/subscriptions/tiers', async () => {
  ...
  fastify.get('/api/studio/fans', { preHandler: [requireAuth] }, async (request) => {
    const userId = (request as any).userId;
