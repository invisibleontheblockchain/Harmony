...
export async function libraryRoutes(fastify: FastifyInstance) {
  fastify.get('/api/library/liked', { preHandler: [requireAuth] }, async (request, reply) => {
  ...
  fastify.post('/api/library/liked/:trackId', { preHandler: [requireAuth] }, async (request, reply) => {
    const userId = (request as any).userId;
  ...
  fastify.delete('/api/library/liked/:trackId', { preHandler: [requireAuth] }, async (request, reply) => {
    const userId = (request as any).userId;
    const { trackId } = request.params as { trackId: string };
  ...
  fastify.get('/api/library/history', { preHandler: [requireAuth] }, async (request) => {
    const userId = (request as any).userId;
  ...
  fastify.get('/api/library/following', { preHandler: [requireAuth] }, async (request) => {
    const userId = (request as any).userId;
